    ...
    public function run()
    {
        ...
        for ($i = 1; $i <= 189; $i++) {
            DB::table('books')->insert([
                ...
                'author' => $faker->randomElement(['Harry Mulisch','Kader Abdolah','Multatuli','J. Bernlef','W.F. Hermans','J.J. Voskuil','Thomas Rosenboom']),
                'category_id' => $faker->randomElement([1, 2, 3]),
                'location' => 'Doos ' . rand(1, 50),
                'bol_link' => $faker->randomElement(['https://www.bol.com/nl/m/boeken', '']),
